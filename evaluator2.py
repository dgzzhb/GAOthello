...
class Evaluator(object):    
    ...
    PIECE_COUNT_WEIGHT = [1, 1, 1, 1, 1]
    POTENTIAL_MOBILITY_WEIGHT= [1, 1, 1, 1, 0]
    MOBILITY_WEIGHT = [1, 1, 1, 1, 0]
    CORNER_WEIGHT= [1, 1, 1, 1, 0]
    EDGE_WEIGHT = [1, 1, 1, 1, 0]
    XSQUARE_WEIGHT = [1, 1, 1, 1, 0]
